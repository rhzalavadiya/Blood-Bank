...
namespace project
{
    public partial class patient : Form
    {
        ...
        {
            con.Open();
            cmd = new OleDbCommand("select * from patient_master", con);
        ...
        private void add_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                cmd = new OleDbCommand("select max(pid) from patient_master", con);
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (radioButton6.Checked == true)
                            rh = radioButton6.Text;
                        if (radioButton7.Checked == true)
                             rh = radioButton7.Text;
                       String gen = "";
                        if (radioButton1.Checked == true)
                             gen = radioButton1.Text;
                        if (radioButton2.Checked == true)
                            gen = radioButton2.Text;
                       String str = "insert into patient_master(pid,pname,gender,dob,age,mobileno,address,city,bg,bagtype,rhfact,emailid) values('" + textBox1.Text + "','" + textBox2.Text + "','" + gen + "','" + dateTimePicker1.Value + "','" + textBox3.Text + "','" + textBox4.Text + "','" + richTextBox1.Text + "','" + textBox5.Text + "','" + comboBox3.Text + "','" + comboBox4.Text + "','" + rh + "','" + textBox6.Text + "')";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                comboBox4.Text = dataGridView1.Rows[e.RowIndex].Cells[9].Value.ToString();
                rh= dataGridView1.Rows[e.RowIndex].Cells[10].Value.ToString();
                if (gen == "Positive")
            ...
            if (res == DialogResult.Yes)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        if (radioButton7.Checked == true)
                            rh = radioButton7.Text;
                        cmd = new OleDbCommand("update patient_master set pname='" + textBox2.Text + "',gender='" + gen + "',dob='" + dateTimePicker1.Value + "',age='" + textBox3.Text + "',mobileno='" + textBox4.Text + "',address='" + richTextBox1.Text + "',city='" + textBox5.Text + "',bg='" + comboBox3.Text + "',bagtype='" + comboBox4.Text + "',rhfact='" + rh + "',emailid='" + textBox6.Text + "'where pid=" + textBox1.Text + "", con);
                        cmd.ExecuteNonQuery();
                        con.Close();
                        dispaly();
                        clear();
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            ...
            if (rus == DialogResult.Yes)
            {
                ...
                {
                    con.Open();
                    cmd = new OleDbCommand("delete from patient_master where pid=" + textBox1.Text + "", con);
                    cmd.ExecuteNonQuery();
                    con.Close();
                }
        ...
        public void storedata(int index)
        {
            ...
            comboBox3.Text = dt.Rows[index][8].ToString();
            comboBox4.Text = dt.Rows[index][9].ToString();
            String rh = "";
            if (radioButton6.Checked == true)
                rh = radioButton6.Text;
            if (radioButton7.Checked == true)
                rh = radioButton7.Text;
            rh = dt.Rows[index][10].ToString();
            if (rh == radioButton6.Text)
                radioButton6.Checked = true;
            else
                radioButton7.Checked = true;
            textBox6.Text = dt.Rows[index][11].ToString();
        }
        ...
        {
            con.Open();
            cmd = new OleDbCommand("select * from patient_master where pid=" + comboBox1.Text + " ", con);
        ...
        private void radioButton4_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButton4.Checked)
            {
                ...
                con.Open();
                cmd = new OleDbCommand("select pname from patient_master", con);
                dr = cmd.ExecuteReader();
                while (dr.Read())
        ...
        {
            con.Open();
            cmd = new OleDbCommand("select * from patient_master where pname='" + comboBox2.Text + "' ", con);
            var r = cmd.ExecuteReader();
            dt = new DataTable();
            dt.Load(r);
            dataGridView1.DataSource = dt;
